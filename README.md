...
# 三、关于资料下载：
    1、《51单片机工程文件》、内有几十个51单片机开发的工程文件、只有将完整例程文件夹下载后、
     并且电脑安装好Keil5软件后、再点击图标、才能看见工程全貌、如果电脑还没安装好Keil5软件、打不开也看不懂这些工程文件。
    2、《51单片机课程PPT》、是与视频课件配套的PPT讲演稿文档、电脑要有播放PPT文档的软件、比如有办公软件WPS才能看、PPT文档最好与视频课件同时看。
    3、《开发工具软件包》、是51单片机开发过程中、要用到的工具软件。
# 四、51单片机课程全资料下载地址：
    0、直接输入域名： makemare.com（提示：电信的宽带网、可能无法打开此网页、移动的宽带网、手机都能打开）。
